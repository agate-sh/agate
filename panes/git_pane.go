...
type GitPane struct {
	*BasePane                     // Embedded BasePane for common functionality
...
func NewGitPane() *GitPane {
	return &GitPane{
		BasePane: NewBasePane(2, "Git"), // Pane index 2
	}
}
...
func (g *GitPane) GetTitleStyle() TitleStyle {
	shortcuts := ""
	if g.IsActive() {
...
func (g *GitPane) Update(msg tea.Msg) (Pane, tea.Cmd) {
