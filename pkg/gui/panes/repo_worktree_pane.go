...
func NewRepoWorktreePane(worktreeManager *git.WorktreeManager) *RepoWorktreePane {
	...
	pane := &RepoWorktreePane{
		BasePane:        NewBasePane(0, "Repos & Worktrees"), // Pane index 0
		list:            l,
...
func (r *RepoWorktreePane) GetTitleStyle() TitleStyle {
	shortcuts := ""
	if r.IsActive() {
...
func (r *RepoWorktreePane) Update(msg tea.Msg) (Pane, tea.Cmd) {
	var cmd tea.Cmd
