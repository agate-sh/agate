...
describe('TmuxSessionManager', () => {
  ...
  describe('createSession', () => {
    ...
    it('should use default cols/rows if not specified', async () => {
      const options = {
        name: 'test-tmux-session-defaults',
  ...
  describe('attachToSession', () => {
    it('should attach to an existing tmux session', async () => {
      ...
      const sessionName = 'test-attach-session';
    ...
    it('should throw if session already created', async () => {
      ...
      await expect(
        sessionManager.attachToSession('other-session', 'gemini', process.cwd()),
